...
- A **Web Auth Endpoint**: a domain hosting an endpoint providing the GET and POST operations discussed in this document. The endpoint may be hosted on a **Home Domain**, a sub-domain of a **Home Domain**, or any other domain.
